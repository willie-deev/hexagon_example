...
public class FixedHexagonalTiledMapRenderer extends BatchTiledMapRenderer{
	...
	public FixedHexagonalTiledMapRenderer(TiledMap map) {
		super(map);
		init(map);
	}

	public FixedHexagonalTiledMapRenderer(TiledMap map, float unitScale) {
		super(map, unitScale);
		init(map);
	}

	public FixedHexagonalTiledMapRenderer(TiledMap map, Batch batch) {
		super(map, batch);
		init(map);
	}

	public FixedHexagonalTiledMapRenderer(TiledMap map, float unitScale, Batch batch) {
